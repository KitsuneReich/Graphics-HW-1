	...
	SubShader
	{
		...
		Pass
		{
			...
			fixed4 frag(v2f i) : SV_Target
			{
                ...
                //Count how many live cells are adjacent
                int cnt = 0;
                for(int i=0;i<8;i++){
                ...
                if (C.b >= 0.5 || C.g > 0.5) { //cell is alive if either green or blue
                    if (cnt == 2 || cnt == 3) {
                        //Any live cell with two or three live neighbours lives on to the next generation.
                        
                        //Color live cell blue
                    ...
                    if (cnt == 3) {
                        ...
                        //Dead to live cell colored green
                        return float4(0.0,1.0,0.0,1.0);
                    } else {
                        //Color any dead cells red
                        return float4(1.0,0.0,0.0,1.0);
